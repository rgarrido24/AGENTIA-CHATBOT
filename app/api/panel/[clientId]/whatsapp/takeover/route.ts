...
import { bridgePausePhone } from '@/lib/baileys-bridge-client';
...
export async function POST(
  ...
  await setHumanMode(clientId, convId, true);
  await bridgePausePhone(clientId, conv.phone);

  return Response.json({ ok: true, humanMode: true });
}
