...
function DashboardLoginForm() {
  ...
  return (
    ...
    >
      <h1 className="text-xl font-bold text-white/95 mb-2">Dashboard</h1>
      <p className="text-sm text-slate-400 mb-6">Acceso de administrador</p>
...
function LoginFallback() {
  return (
    <div
      className="w-full max-w-sm rounded-2xl p-8 shadow-xl animate-pulse"
      style={{
        background: 'rgba(255,255,255,0.06)',
        backdropFilter: 'blur(12px)',
        border: '1px solid rgba(255,255,255,0.08)',
    ...
    >
      <div className="h-6 bg-slate-600/50 rounded w-24 mb-2" />
      <div className="h-4 bg-slate-600/30 rounded w-48 mb-6" />
      <div className="h-12 bg-slate-700/50 rounded mb-4" />
      <div className="h-12 bg-slate-700/50 rounded mb-4" />
      <div className="h-12 bg-slate-600/50 rounded" />
    </div>
  );
}
