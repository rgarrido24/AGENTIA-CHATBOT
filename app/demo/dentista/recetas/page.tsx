            ...
            return (
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className={`text-xs font-bold ${active ? 'text-sky-300' : 'text-slate-300'}`}>{meta.title}</p>
                    <p className="text-[11px] text-slate-500 mt-0.5">{meta.sub}</p>
                    <span
                      className={`text-[10px] px-1.5 py-0.5 rounded mt-1.5 inline-block ${
                        n === 2 ? 'bg-sky-600/30 text-sky-300' : 'bg-white/5 text-slate-400'
                      }`}
                    >
                      {meta.badge}
                    </span>
          ...
          <div className="space-y-4 border-t border-white/10 pt-4">
            <div className="grid sm:grid-cols-2 gap-3">
              <div>
                ...
                <input value={cedula} onChange={(e) => setCedula(e.target.value)} className={inputCls} placeholder="1234567" />
              </div>
              <div>
              ...
              {firmaTab === 'dibujar' ? (
                firmaBase64 && !showCanvas ? (
                  <div className="space-y-2">
                    ...
                    <button type="button" onClick={() => { setFirmaBase64(''); setShowCanvas(true); }} className="text-xs text-sky-400">
                      Redibujar
                    </button>
                  </div>
                ) : (
          ...
          <div className="space-y-4 border-t border-white/10 pt-4">
            <div className="rounded-xl border border-blue-500/30 bg-blue-900/20 p-4 space-y-3">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-300 mt-1 leading-relaxed">
                    La e.firma del SAT otorga <strong>VALIDEZ LEGAL PLENA</strong> a tus recetas
                    médicas, equiparable a la firma autógrafa según el Código de Comercio y
                    NOM-024-SSA3-2010.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 text-xs">
                ...
                <a href="mailto:contacto@agentia.software" className="text-sky-400 hover:underline">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          ...
          <div className="sm:col-span-2">
            ...
            <select value={dentista} onChange={(e) => setDentista(e.target.value)} className={inputCls}>
              {DENTISTAS.map((d) => (
        ...
        <div>
          ...
          <button type="button" onClick={agregarMed} className="text-xs text-sky-400">+ Agregar</button>
        </div>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-semibold text-white bg-sky-600 hover:bg-sky-500"
        >
