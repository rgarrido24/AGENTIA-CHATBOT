...
async function main() {
  ...
  const systemPrompt = [
    ...
    '',
    'PRECIOS:',
    '- Lealtad Agentia (recompra, /lealtad): SÍ di el precio.',
    '  Un solo plan $499 MXN/mes, todo incluido.',
    '  NUNCA menciones $299, plan Básico ni niveles.',
    '- Cualquier otro producto Agentia: NO des precios;',
    '  di que un asesor te contactará.',
    '- Vendedores de Lealtad: solo idea general',
    '  (comisiones recurrentes, sin inversión).',
    '  NUNCA montos, %, ni estructura. Pasa a WhatsApp',
    '  con un asesor para los detalles.',
    '',
    ...
    "'Es un solo plan: $499 MXN al mes, todo incluido (tarjetas ilimitadas, Wallet, WhatsApp automático, panel, hasta 3 sucursales, cumpleaños y soporte). ¿Me das tu nombre y WhatsApp y te conecto?'",
  ...
  const knowledge = [
    ...
    '',
    'LEALTAD AGENTIA (https://agentia.software/lealtad):',
    'Un solo plan $499 MXN/mes, todo incluido.',
    'No hay plan Básico ni $299 ni niveles.',
    'Vendedores: comisiones recurrentes, sin inversión.',
    'Sin montos ni % en público; detalles por WhatsApp.',
    '',
    'TECNOLOGÍA:',
