  ...
  const profiles = [
    ...
    },
    {
      ...
      systemPrompt: [
        ...
        "PLAN BASE $399 MXN/mes (1 sucursal). +$150 MXN/mes por sucursal extra. Incluye: tarjetas ilimitadas, sellos/puntos/cashback a elección, Google Wallet + PWA, WhatsApp por inactividad, panel con semáforo, cumpleaños, soporte WhatsApp.",
        "NUNCA menciones $299, $499, plan Básico, Pro ni niveles. No compares planes de Lealtad.",
